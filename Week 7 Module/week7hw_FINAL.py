...
sample1['Year']=sample1['datadate'].dt.year
sample1['Month']=sample1['datadate'].dt.month

#Earnings Yield Formula
sample1['EY'] = sample1['epspiq'] / sample1['lagPrice2']

#Price-to-Book Ratio Formula
sample1['P_B'] = sample1['lagPrice2'] / (sample1['atq'] / sample1['lagShareturnover2'])

sample1.to_stata(r"C:\Users\rdg83\OneDrive - Rutgers University\Course Investment Portfolio Management\Week 7 Stuff\finalsample_updated.dta")

"""Problem 2 -  Split your new dataset into training and testing samples. Testing sample should include data
with year>=2016 """
Train1 = sample1[sample1['Year'] < 2016]
Test1 = sample1[sample1['Year'] >= 2016]
"""Linear regression"""
