...
data1=pd.read_excel(r"C:\Users\rdg83\OneDrive - Rutgers University\Course Investment Portfolio Management\Week 5 Stuff/Linear Regression Example.xlsx", "Sheet1")
...
#we add a constant variable to X
...
reg1.summary()
print(reg1.summary())
#y_pred=2.8132+0.8497*x


y_pred = reg1.predict(x_cons) 



plt.plot(x,y,  marker='.', markersize=20, color='blue', linewidth=0)
plt.plot(x,y_pred, color='red', linewidth=2, linestyle='dashed')
plt.xlabel('x', fontsize=20)
plt.ylabel('y', fontsize=20)
plt.title('linear regression', fontsize=20)
plt.legend(['real y','predicted y'], fontsize=20)



"Multiple independent variables"

data2=pd.read_excel(r"C:\Users\rdg83\OneDrive - Rutgers University\Course Investment Portfolio Management\Week 5 Stuff/Linear Regression Example.xlsx", "Sheet2")
...
reg2=sm.OLS(y,x_cons).fit().get_robustcov_results(cov_type='HC0')
...
prank1=pd.read_stata(r"C:\Users\rdg83\OneDrive - Rutgers University\Course Investment Portfolio Management\Week 3 Stuff\week 3 sample.dta")
